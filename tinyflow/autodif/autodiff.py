...
class MatMulOp(Op):
    ...
    def compute(self, node, input_vals):
        ...
        matrix_a = input_vals[0] if not node.matmul_attr_trans_A else input_vals[0].transpose()
        matrix_b = input_vals[1] if not node.matmul_attr_trans_B else input_vals[1].transpose()
