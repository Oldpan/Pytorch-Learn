...
img_PIL = Image.open('./exam-images/dancing.jpg')
img_skimage = io.imread('./exam-images/dancing.jpg')
img_opencv = cv2.imread('./exam-images/dancing.jpg')
img_plt = plt.imread('./exam-images/dancing.jpg')

print(
    'The shape of \n img_skimage is {}\n img_opencv is {}\n img_plt is {}\n'.format(img_skimage.shape, img_opencv.shape,
                                                                                    img_plt.shape))
print('The size of img_PIL is {} \n The mode of img_PIL is {}'.format(img_PIL.size, img_PIL.mode))
print('The type of \n img_skimage is {}\n img_opencv is {}\n img_plt is {}\n img_PIL is {}'.format(type(img_skimage),
                                                                                                   type(img_opencv),
                                                                                                   type(img_plt),
                                                                                                   type(img_PIL)))
